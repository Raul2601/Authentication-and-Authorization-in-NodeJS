...
@NgModule({
  declarations: [AdminComponent, ViewRoleComponent, ViewRolesComponent, ViewPermissionsComponent, EditRoleComponent, EditPermissionComponent, ViewUsersComponent],
  imports: [
    CommonModule,
    AdminRoutingModule,
    FormsModule,
